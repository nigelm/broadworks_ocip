...
def open_output_files():
    ...
    for thing in ("type", "request", "response"):
        ...
        out.write(f"Autogenerated from the Broadworks XML Schemas.\n")
        out.write(f"Do not edit as changes will be overwritten.\n")
        out.write(f"Generated on {generation_time.isoformat()}\n")
        out.write(f'"""\n\n')
        out.write(f"from classforge import Field\n\n")
        if thing in ("request", "response"):
            out.write(f"import broadworks_ocip.types as OCI\n")
        out.write(f"from .base import ElementInfo as E\n")
