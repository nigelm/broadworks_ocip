...
# Generated on 2022-02-12T20:11:58.879265
...
class CallCenterReportCurrentInterval(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("time_unit", "timeUnit", str, is_required=True),)
...
class CallCenterReportDataTemplateQueryFilterValueReplacementList(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("filter_value", "filterValue", str, is_required=True, is_array=True),)
...
class CommunicationBarringProfileReplacementList(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("profile_name", "profileName", str, is_required=True, is_array=True),)
...
class CriteriaReplacementDNList(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("phone_number", "phoneNumber", str, is_required=True, is_array=True),)
...
class EnterpriseVoiceVPNDigitManipulationNoValue(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("operation", "operation", str, is_required=True),)
...
class GroupHuntGroupGetInstanceRequest17sp1V1(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("service_user_id", "serviceUserId", str, is_required=True),)
...
class OutgoingCallingPlanRedirectedPermissions(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("outside_group", "outsideGroup", bool, is_required=True),)
...
class OutgoingCallingPlanRedirectedPermissionsModify(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("outside_group", "outsideGroup", bool),)
...
class ReplacementCommunicationBarringCallTypeList(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("call_type", "callType", str, is_required=True, is_array=True),)
...
class ReplacementContactList(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("contact", "contact", str, is_required=True, is_array=True),)
...
class ReplacementEnterpriseTrunkTrunkGroupList(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("trunk_group", "trunkGroup", str, is_required=True, is_array=True),)
...
class ReplacementMediaNameList(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("media_name", "mediaName", str, is_required=True, is_array=True),)
...
class ReplacementNumberPortabilityStatusList(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("status", "status", str, is_required=True, is_array=True),)
...
class ReplacementSIPAliasList(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("sip_alias", "sipAlias", str, is_required=True, is_array=True),)
...
class ReplacementUserIdList(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("user_id", "userId", str, is_required=True, is_array=True),)
...
class ReplacementUserServiceList(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("service_name", "serviceName", str, is_required=True, is_array=True),)
...
class ReplacementZoneList(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("zone_name", "zoneName", str, is_required=True, is_array=True),)
...
class SearchCriteriaExactCallCenterScheduledReportServiceProvider(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("service_provider_id", "serviceProviderId", str, is_required=True),)
...
class SearchCriteriaExactDeviceLevel(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("device_level", "deviceLevel", str, is_required=True),)
...
class SearchCriteriaExactDeviceManagementEventAction(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("dm_event_action", "dmEventAction", str, is_required=True),)
...
class SearchCriteriaExactDeviceManagementEventLevel(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("dm_event_level", "dmEventLevel", str, is_required=True),)
...
class SearchCriteriaExactDeviceManagementEventType(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("dm_event_type", "dmEventType", str, is_required=True),)
...
class SearchCriteriaExactDeviceType(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("device_type", "deviceType", str, is_required=True),)
...
class SearchCriteriaExactDnActivation(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("activated", "activated", bool, is_required=True),)
...
class SearchCriteriaExactEndpointType(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("endpoint_type", "endpointType", str, is_required=True),)
...
class SearchCriteriaExactMobileNetwork(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("mobile_network_name", "mobileNetworkName", str, is_required=True),)
...
class SearchCriteriaExactOrganizationType(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("organization_type", "organizationType", str, is_required=True),)
...
class SearchCriteriaExactPolicySelection(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("policy_selection", "policySelection", str, is_required=True),)
...
class SearchCriteriaExactPortNumber(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("port", "port", int, is_required=True),)
...
class SearchCriteriaExactServiceType(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("service_type", "serviceType", str, is_required=True),)
...
class SearchCriteriaExactSignalingAddressType(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("profile", "profile", str, is_required=True),)
...
class SearchCriteriaExactSkillLevel(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("skill_level", "skillLevel", int, is_required=True),)
...
class SearchCriteriaExactUserInTrunkGroup(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("user_in_trunk_group", "userInTrunkGroup", bool, is_required=True),)
...
class SearchCriteriaExactUserRouteListAssigned(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("route_list_assigned", "routeListAssigned", bool, is_required=True),)
...
class SearchCriteriaExactUserRouteListAssignment(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("assigned", "assigned", bool, is_required=True),)
...
class SearchCriteriaExactUserType(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("user_type", "userType", str, is_required=True),)
...
class SystemCommunicationBarringProfileGetRequest19sp1V2(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("name", "name", str, is_required=True),)
...
class UserTwoStageDialingGetRequest13Mp20(OCIType):
    ...
    @classmethod
    def _elements(cls) -> Tuple[E, ...]:
        return (E("user_id", "userId", str, is_required=True),)
