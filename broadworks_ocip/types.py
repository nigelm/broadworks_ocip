...
# Generated on 2022-01-12T21:34:08.252708
# fmt: off
...
class AttendantConsoleReplacementDisplayColumnList(OCIType):
    ...
    display_column: "List[str]" = Field(type=list, required=True, mutable=False)
...
class BroadWorksMobilityAlertingMobileNumberReplacementList(OCIType):
    ...
    mobile_number: "List[str]" = Field(type=list, required=True, mutable=False)
...
class CallCenterAgentThresholdProfileReplacementNotificationEmailList(OCIType):
    ...
    email_address: "List[str]" = Field(type=list, required=True, mutable=False)
...
class CallCenterReportAbandonedCallThresholdReplacementList(OCIType):
    ...
    _ELEMENTS = (
        E(
            ...
            is_required=True, is_array=True,
        ),
    )
...
class CallCenterReportDataTemplateQueryFilterValueReplacementList(OCIType):
    ...
    filter_value: "List[str]" = Field(type=list, required=True, mutable=False)
...
class CallCenterScheduledReportCallCenterSelectionRead(OCIType):
    ...
    all_call_center: bool = Field(type=bool, required=False, mutable=False)
    current_user_id: "List[str]" = Field(type=list, required=False, mutable=False)
    past_user_id: "List[str]" = Field(type=list, required=False, mutable=False)
...
class CallCenterScheduledReportDNISSelectionRead(OCIType):
    ...
    all_dnis: bool = Field(type=bool, required=False, mutable=False)
    current_name: "List[str]" = Field(type=list, required=False, mutable=False)
    past_name: "List[str]" = Field(type=list, required=False, mutable=False)
...
class CommunicationBarringProfileReplacementList(OCIType):
    ...
    profile_name: "List[str]" = Field(type=list, required=True, mutable=False)
...
class CriteriaReplacementDNList(OCIType):
    ...
    phone_number: "List[str]" = Field(type=list, required=True, mutable=False)
...
class ReplacementCallProcessingPolicyProfileSubscriberTypeList(OCIType):
    ...
    subscriber_type: "List[str]" = Field(type=list, required=True, mutable=False)
...
class ReplacementCommunicationBarringAlternateCallIndicatorList(OCIType):
    ...
    _ELEMENTS = (
        E(
            "alternate_call_indicator", "alternateCallIndicator", str, is_required=True,
            is_array=True,
        ),
    )

    alternate_call_indicator: "List[str]" = Field(type=list, required=True, mutable=False)
...
class ReplacementCommunicationBarringCallTypeList(OCIType):
    ...
    call_type: "List[str]" = Field(type=list, required=True, mutable=False)
...
class ReplacementContactList(OCIType):
    ...
    contact: "List[str]" = Field(type=list, required=True, mutable=False)
...
class ReplacementEnterpriseTrunkTrunkGroupList(OCIType):
    ...
    trunk_group: "List[str]" = Field(type=list, required=True, mutable=False)
...
class ReplacementMediaNameList(OCIType):
    ...
    media_name: "List[str]" = Field(type=list, required=True, mutable=False)
...
class ReplacementNumberPortabilityStatusList(OCIType):
    ...
    status: "List[str]" = Field(type=list, required=True, mutable=False)
...
class ReplacementOCICallControlApplicationIdList(OCIType):
    ...
    application_id: "List[str]" = Field(type=list, required=True, mutable=False)
...
class ReplacementSIPAliasList(OCIType):
    ...
    sip_alias: "List[str]" = Field(type=list, required=True, mutable=False)
...
class ReplacementServicePackNameList(OCIType):
    ...
    _ELEMENTS = (
        E("service_pack_name", "servicePackName", str, is_required=True, is_array=True),
    )

    service_pack_name: "List[str]" = Field(type=list, required=True, mutable=False)
...
class ReplacementUserIdList(OCIType):
    ...
    user_id: "List[str]" = Field(type=list, required=True, mutable=False)
...
class ReplacementUserServiceList(OCIType):
    ...
    service_name: "List[str]" = Field(type=list, required=True, mutable=False)
...
class ReplacementVirtualOnNetCallTypeNameList(OCIType):
    ...
    _ELEMENTS = (
        E(
            "virtual_on_net_call_type_name", "virtualOnNetCallTypeName", str,
            is_required=True, is_array=True,
        ),
    )
...
class ReplacementZoneList(OCIType):
    ...
    zone_name: "List[str]" = Field(type=list, required=True, mutable=False)
...
class TrunkGroupDeviceMultipleContactEndpointAdd(OCIType):
    ...
    name: str = Field(type=str, required=True, mutable=False)
    line_port: str = Field(type=str, required=True, mutable=False)
    contact: "List[str]" = Field(type=list, required=False, mutable=False)
...
class CommPilotExpressSRRedirectionWithRingList(OCIType):
    ...
    number_entry: "List[CommPilotExpressSRRedirectionWithRing]" = Field(
...
class EnhancedCallLogsNumberFilter(OCIType):
    ...
    _ELEMENTS = (
        ...
        E(
            "include_configurable_call_type", "includeConfigurableCallType", str,
            is_array=True,
        ),
        E(
            "search_criteria_dialed_number", "searchCriteriaDialedNumber",
            SearchCriteriaOutgoingDNorSIPURI, is_complex=True, is_array=True,
        ),
        E(
            "search_criteria_called_number", "searchCriteriaCalledNumber",
            SearchCriteriaOutgoingDNorSIPURI, is_complex=True, is_array=True,
    ...
    include_basic_call_type: "List[str]" = Field(type=list, required=False, mutable=False)
    include_call_category: "List[str]" = Field(type=list, required=False, mutable=False)
    include_configurable_call_type: "List[str]" = Field(
        type=list, required=False, mutable=False,
    )
    search_criteria_dialed_number: "List[SearchCriteriaOutgoingDNorSIPURI]" = Field(
        type=list, required=False, mutable=False,
    )
    search_criteria_called_number: "List[SearchCriteriaOutgoingDNorSIPURI]" = Field(
        type=list, required=False, mutable=False,
    )
    search_criteria_network_translated_number: "List[SearchCriteriaOutgoingDNorSIPURI]" = Field(
        type=list, required=False, mutable=False,
    )
    search_criteria_calling_presentation_number: "List[SearchCriteriaOutgoingDNorSIPURI]" = Field(
        type=list, required=False, mutable=False,
    )
...
class EnhancedCallLogsRedirectedNumberFilter(OCIType):
    ...
    _ELEMENTS = (
        ...
        E(
            ...
            "includeServiceInvocationBasicCallType", str, is_array=True,
        ),
        E(
            "include_service_invocation_call_category",
            "includeServiceInvocationCallCategory", str, is_array=True,
        ),
        E(
            "include_service_invocation_configurable_call_type",
            "includeServiceInvocationConfigurableCallType", str, is_array=True,
        ),
        E(
            "search_criteria_service_invocation_dialed_number",
            "searchCriteriaServiceInvocationDialedNumber",
    ...
    include_service_invocation_basic_call_type: "List[str]" = Field(
        type=list, required=False, mutable=False,
    )
    include_service_invocation_call_category: "List[str]" = Field(
        type=list, required=False, mutable=False,
    )
    include_service_invocation_configurable_call_type: "List[str]" = Field(
        type=list, required=False, mutable=False,
    )
    search_criteria_service_invocation_dialed_number: "List[SearchCriteriaOutgoingDNorSIPURI]" = Field(
        type=list, required=False, mutable=False,
    )
    search_criteria_service_invocation_called_number: "List[SearchCriteriaOutgoingDNorSIPURI]" = Field(
        type=list, required=False, mutable=False,
    )
    search_criteria_service_invocation_network_translated_number: "List[SearchCriteriaOutgoingDNorSIPURI]" = Field(
        type=list, required=False, mutable=False,
    )
...
class MWIDeliveryToMobileEndpointTemplateBody(OCIType):
    ...
    line: "List[MWIDeliveryToMobileEndpointTemplateLine]" = Field(
        type=list, required=True, mutable=False,
    )
...
class OutgoingCallingPlanDigitPatternCallMeNowPermissions(OCIType):
    ...
    digit_pattern_permissions: "List[OutgoingCallingPlanDigitPatternCallMeNowPermission]" = Field(
        type=list, required=True, mutable=False,
    )
...
class OutgoingCallingPlanDigitPatternOriginatingPermissions(OCIType):
    ...
    digit_pattern_permissions: "List[OutgoingCallingPlanDigitPatternOriginatingPermission]" = Field(
        type=list, required=True, mutable=False,
    )
...
class OutgoingCallingPlanDigitPatternRedirectingPermissions(OCIType):
    ...
    digit_pattern_permissions: "List[OutgoingCallingPlanDigitPatternRedirectingPermission]" = Field(
        type=list, required=True, mutable=False,
    )
...
class OutgoingPinholeDigitPlanDigitPatternCallMeNowPermissions(OCIType):
    ...
    digit_pattern_permissions: "List[OutgoingPinholeDigitPlanDigitPatternCallMeNowPermission]" = Field(
        type=list, required=True, mutable=False,
    )
...
class OutgoingPinholeDigitPlanDigitPatternOriginatingPermissions(OCIType):
    ...
    digit_pattern_permissions: "List[OutgoingPinholeDigitPlanDigitPatternOriginatingPermission]" = Field(
        type=list, required=True, mutable=False,
    )
...
class OutgoingPinholeDigitPlanDigitPatternRedirectingPermissions(OCIType):
    ...
    digit_pattern_permissions: "List[OutgoingPinholeDigitPlanDigitPatternRedirectingPermission]" = Field(
        type=list, required=True, mutable=False,
    )
...
class ReplacementCallToNumberList(OCIType):
    ...
    _ELEMENTS = (
        E(
            "call_to_number", "callToNumber", CallToNumber, is_complex=True,
            is_required=True, is_array=True,
        ),
    )

    call_to_number: "List[CallToNumber]" = Field(type=list, required=True, mutable=False)
...
class ReplacementCommunicationBarringCallMeNowRuleList(OCIType):
    ...
    rule: "List[CommunicationBarringCallMeNowRule]" = Field(
        type=list, required=True, mutable=False,
    )
...
class ReplacementCommunicationBarringIncomingRuleList(OCIType):
    ...
    rule: "List[CommunicationBarringIncomingRule]" = Field(
        type=list, required=True, mutable=False,
    )
...
class ReplacementCommunicationBarringOriginatingRuleList(OCIType):
    ...
    rule: "List[CommunicationBarringOriginatingRule]" = Field(
        type=list, required=True, mutable=False,
    )
...
class ReplacementCommunicationBarringRedirectingRuleList(OCIType):
    ...
    rule: "List[CommunicationBarringRedirectingRule]" = Field(
        type=list, required=True, mutable=False,
    )
...
class ReplacementCustomContactDirectoryEntryList(OCIType):
    ...
    _ELEMENTS = (
        E(
            "entry", "entry", CustomContactDirectoryEntry, is_complex=True,
            is_required=True, is_array=True,
        ),
    )

    entry: "List[CustomContactDirectoryEntry]" = Field(
        type=list, required=True, mutable=False,
    )
...
class ReplacementDeviceList(OCIType):
    ...
    _ELEMENTS = (
        E("device", "device", AccessDevice, is_complex=True, is_required=True, is_array=True),
    )

    device: "List[AccessDevice]" = Field(type=list, required=True, mutable=False)
...
class ReplacementEnterpriseTrunkTrunkGroupKeyList(OCIType):
    ...
    _ELEMENTS = (
        E(
            ...
            is_complex=True, is_required=True, is_array=True,
        ),
    )
...
class ServiceInstanceAddProfile(OCIType):
    ...
    alias: "List[str]" = Field(type=list, required=False, mutable=False)
...
class AutoAttendantReadMenu19(OCIType):
    ...
    key_configuration: "List[AutoAttendantKeyReadConfiguration19]" = Field(
        type=list, required=False, mutable=False,
    )
...
class ReplacementEnterpriseDeviceList(OCIType):
    ...
    _ELEMENTS = (
        E(
            "device", "device", EnterpriseAccessDevice, is_complex=True, is_required=True,
            is_array=True,
        ),
    )

    device: "List[EnterpriseAccessDevice]" = Field(type=list, required=True, mutable=False)
...
class SystemSIPDeviceTypeGetResponse18sp1V2(OCIType):
    ...
    protocol_choice: "List[str]" = Field(type=list, required=True, mutable=False)
...
class AutoAttendantAddMenu(OCIType):
    ...
    key_configuration: "List[AutoAttendantKeyConfiguration]" = Field(
        type=list, required=False, mutable=False,
    )
...
class AutoAttendantAddMenu19(OCIType):
    ...
    key_configuration: "List[AutoAttendantKeyConfiguration19]" = Field(
        type=list, required=False, mutable=False,
    )
...
class AutoAttendantAddMenu20(OCIType):
    ...
    key_configuration: "List[AutoAttendantKeyConfiguration20]" = Field(
        type=list, required=False, mutable=False,
    )
...
class AutoAttendantModifyMenu(OCIType):
    ...
    key_configuration: "List[AutoAttendantKeyModifyConfiguration]" = Field(
        type=list, required=False, mutable=False,
    )
...
class AutoAttendantModifyMenu20(OCIType):
    ...
    _ELEMENTS = (
        ...
        E(
            "key_configuration", "keyConfiguration",
            AutoAttendantKeyModifyConfiguration20, is_complex=True, is_array=True,
        ),
    )
    ...
    key_configuration: "List[AutoAttendantKeyModifyConfiguration20]" = Field(
        type=list, required=False, mutable=False,
    )
...
class AutoAttendantReadMenu20(OCIType):
    ...
    key_configuration: "List[AutoAttendantKeyReadConfiguration20]" = Field(
        type=list, required=False, mutable=False,
    )
