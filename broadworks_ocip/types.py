...
# Generated on 2020-09-30T17:06:11.277617
...
class CollaborateRoomSchedule(OCIType):
    ...
    #: str: *Required* scheduleReservationless
    schedule_reservationless = Field(
        type=str,
        required=True,
    )
    #: str: *Required* scheduleOneTime
    schedule_one_time = Field(
        type=str,
        required=True,
    )
    #: str: *Required* scheduleRecurring
...
class DefaultNetworkClassOfService(OCIType):
    ...
    #: bool: *Required* useExisting
    use_existing = Field(
        type=bool,
        required=True,
    )
    #: str: *Required* networkClassOfServiceName
...
class EnhancedCallLogsAccountAuthorizationCodeFilter(OCIType):
    ...
    #: bool: *Required* callsWithCodes
    calls_with_codes = Field(
        type=bool,
        required=True,
    )
    #: str: *Required* accountAuthorizationCode
...
class EnhancedCallLogsCallAuthorizationCodeFilter(OCIType):
    ...
    #: str: *Required* authorizationCode
...
class EnhancedCallLogsRedirectedCallSelection(OCIType):
    ...
    #: list: *Optional* redirectType  *Array*
    redirect_type = Field(
        type=list,
        required=False,
    )
...
class MusicOnHoldSourceAdd21(OCIType):
    ...
    #: str: *Required* labeledCustomSourceMediaFiles
    labeled_custom_source_media_files = Field(
        type=str,
        required=True,
    )
    #: str: *Required* announcementCustomSourceMediaFiles
...
class Recurrence(OCIType):
    ...
    #: str: *Required* recurDaily
    recur_daily = Field(
        type=str,
        required=True,
    )
    #: str: *Required* recurWeekly
    recur_weekly = Field(
        type=str,
        required=True,
    )
    #: str: *Required* recurMonthlyByDay
    recur_monthly_by_day = Field(
        type=str,
        required=True,
    )
    #: str: *Required* recurMonthlyByWeek
    recur_monthly_by_week = Field(
        type=str,
        required=True,
    )
    #: str: *Required* recurYearlyByDay
    recur_yearly_by_day = Field(
        type=str,
        required=True,
    )
    #: str: *Required* recurYearlyByWeek
    recur_yearly_by_week = Field(
        type=str,
        required=True,
    )
    #: bool: *Required* recurForEver
    recur_for_ever = Field(
        type=bool,
        required=True,
    )
    #: str: *Required* recurEndDate
    recur_end_date = Field(
        type=str,
        required=True,
    )
    #: int: *Required* recurEndOccurrence
...
class UserEnhancedCallLogsGetListResponse17sp4V2(OCIType):
    ...
    #: str: *Required* legacyEntry
    legacy_entry = Field(
        type=str,
        required=True,
    )
    #: str: *Required* extendedEntry
...
class EnhancedCallLogsNumberFilter(OCIType):
    ...
    #: str: *Required* includeBasicCallType
    include_basic_call_type = Field(
        type=str,
        required=True,
    )
    #: str: *Required* includeCallCategory
    include_call_category = Field(
        type=str,
        required=True,
    )
    #: str: *Required* includeConfigurableCallType
    include_configurable_call_type = Field(
        type=str,
        required=True,
    )
    #: SearchCriteriaOutgoingDNorSIPURI: *Required* searchCriteriaDialedNumber
    search_criteria_dialed_number = Field(
        type=SearchCriteriaOutgoingDNorSIPURI,
        required=True,
    )
    #: SearchCriteriaOutgoingDNorSIPURI: *Required* searchCriteriaCalledNumber
    search_criteria_called_number = Field(
        type=SearchCriteriaOutgoingDNorSIPURI,
        required=True,
    )
    #: SearchCriteriaOutgoingDNorSIPURI: *Required* searchCriteriaNetworkTranslatedNumber
    search_criteria_network_translated_number = Field(
        type=SearchCriteriaOutgoingDNorSIPURI,
        required=True,
    )
    #: SearchCriteriaOutgoingDNorSIPURI: *Required*
    #: searchCriteriaCallingPresentationNumber
...
class EnhancedCallLogsRedirectedNumberFilter(OCIType):
    ...
    #: EnhancedCallLogsRedirectedCallSelection: *Required* redirectedCall
    redirected_call = Field(
        type=EnhancedCallLogsRedirectedCallSelection,
        required=True,
    )
    #: str: *Required* includeServiceInvocationBasicCallType
    include_service_invocation_basic_call_type = Field(
        type=str,
        required=True,
    )
    #: str: *Required* includeServiceInvocationCallCategory
    include_service_invocation_call_category = Field(
        type=str,
        required=True,
    )
    #: str: *Required* includeServiceInvocationConfigurableCallType
...
class EnhancedCallLogsRedirectedNumberFilter21(OCIType):
    ...
    #: EnhancedCallLogsRedirectedCallSelection21: *Required* redirectedCall
    redirected_call = Field(
...
class GroupServiceAuthorization(OCIType):
    ...
    #: UnboundedPositiveInt: *Required* authorizedQuantity
    authorized_quantity = Field(
        type=UnboundedPositiveInt,
        required=True,
    )
    #: bool: *Required* unauthorized
    unauthorized = Field(
        type=bool,
        required=True,
    )
...
class IncomingCallingPlanDepartmentPermissions(OCIType):
    ...
    #: IncomingCallingPlanDigitPatternPermission: *Optional* digitPatternPermission
    #:  *Array*
    digit_pattern_permission = Field(
        type=IncomingCallingPlanDigitPatternPermission,
        required=False,
    )
...
class OutgoingCallingPlanDepartmentAuthorizationCodes(OCIType):
    ...
    #: OutgoingCallingPlanAuthorizationCodeEntry: *Optional* codeEntry  *Array*
    code_entry = Field(
        type=OutgoingCallingPlanAuthorizationCodeEntry,
        required=False,
    )
...
class ServiceProviderCommunicationBarringProfileGetResponse19sp1V2(OCIType):
    ...
    #: ServiceProviderCommunicationBarringHierarchicalOriginatingRule: *Optional*
    ...
    #: ServiceProviderCommunicationBarringHierarchicalRedirectingRule: *Optional*
    ...
    #: ServiceProviderCommunicationBarringHierarchicalCallMeNowRule: *Optional*
    #: callMeNowRule  *Array*
    ...
    #: CommunicationBarringIncomingRule19sp1: *Optional* incomingRule  *Array*
    incoming_rule = Field(
        type=CommunicationBarringIncomingRule19sp1,
        required=False,
    )
...
class SystemCommunicationBarringProfileGetResponse19sp1V2(OCIType):
    ...
    #: CommunicationBarringOriginatingRule: *Optional* originatingRule  *Array*
    originating_rule = Field(
        type=CommunicationBarringOriginatingRule,
        required=False,
    )
    ...
    #: CommunicationBarringRedirectingRule: *Optional* redirectingRule  *Array*
    redirecting_rule = Field(
        type=CommunicationBarringRedirectingRule,
        required=False,
    )
    ...
    #: CommunicationBarringCallMeNowRule: *Optional* callMeNowRule  *Array*
    call_me_now_rule = Field(
        type=CommunicationBarringCallMeNowRule,
        required=False,
    )
...
class CallCenterReportInterval(OCIType):
    ...
    #: CallCenterReportIntervalDates: *Required* dates
    dates = Field(
        type=CallCenterReportIntervalDates,
        required=True,
    )
    #: CallCenterReportCurrentInterval: *Required* current
    current = Field(
        type=CallCenterReportCurrentInterval,
        required=True,
    )
    #: CallCenterReportPastInterval: *Required* past
    past = Field(
...
class CallCenterReportSchedule(OCIType):
    ...
    #: CallCenterReportScheduleTime: *Required* scheduleTime
    schedule_time = Field(
        type=CallCenterReportScheduleTime,
        required=True,
    )
    #: CallCenterReportScheduleRecurrence: *Required* recurrence
    recurrence = Field(
...
class GroupHuntGroupAddInstanceRequest17sp1V1(OCIType):
    ...
    #: list: *Optional* agentUserId  *Array*
    agent_user_id = Field(
        type=list,
        required=False,
    )
...
class GroupTrunkGroupAddInstanceRequest14sp9A(OCIType):
    ...
    #: list: *Optional* hostedUserId  *Array*
